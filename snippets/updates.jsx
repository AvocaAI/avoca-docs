  ...
  "updates": [
    ...
    },
    {
      ...
      "items": [
        {
          "label": "Unified View",
          "description": "Call Types and Call Reasons are now shown in a single consolidated table, simplifying the review process"
        },
        {
          "label": "Smarter Filtering",
          "description": "Use column-level filters and quick-select options like Qualified Unbooked and Unreviewed for faster navigation"
        },
        {
          "label": "Manual Edits",
          "description": "You can now manually change Call Types and Reasons—no longer limited to AI-suggested options"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "description": "When you manually update a Call Type, the system will analyze your changes and suggest updates to your bookability criteria"
        },
        {
          "label": "Easy Setup",
          "description": "To enable this, go to Settings and turn on 'Suggest Bookability Criteria Updates During Reclassification'"
        }
      ]
    },
    {
      ...
      "items": [
        {
          "label": "Cleaner, More Intuitive UX",
          "description": "Improved interface for managing reclassification settings"
        },
        {
          "label": "Suggest Bookability Criteria Updates During Reclassification",
          "description": "New Setting -- Enable AI to recommend changes to your bookability rules during reclassification"
        },
        {
          "label": "Auto Call Types Reclassification",
          "description": "New Setting -- Choose which Call Types should be automatically reclassified by the system"
        }
      ]
    },
    {
