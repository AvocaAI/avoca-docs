...
description: 'Initialize a new live chat session for your website'
---

<Note>
  Create AI-powered live chat sessions for website visitors. The chat widget can be embedded on any page and provides real-time communication with intelligent responses.
</Note>
