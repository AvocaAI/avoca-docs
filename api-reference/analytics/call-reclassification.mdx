...
<Note>
  Use this endpoint to correct or update call classifications, improving the accuracy of your analytics and AI training data. Reclassifications help train the AI to better categorize future calls.
</Note>
