...
<Note>
  Track and analyze the performance of your AI assistants and human agents. This endpoint provides detailed metrics on call handling, customer satisfaction, and adherence to best practices.
</Note>
